...
> | ---- | ------------------- | -------------------- | ------------------------------------ | -------- |
> | E2E | `e2eApplicability` | 「E2E」+「豁免/不适用/无」 | 按 §8.3 适用范围放行 | §8.3 |
...
> R14/R15/R16/E2E 的双要素豁免机制唯一权威定义见 §8.2「双要素豁免机制」表，本索引不再重复各字段名/关键词。
