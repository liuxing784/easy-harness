 ...
 * 判据顺序的说明权威见 `.cursor/harness/spec/mechanical-gates.md` §8.2（执行权威：Hook/脚本），修改行为须同步更新该节。
...
async function main() {
  ...
  try {
    ...
    // R9 软性提醒（非阻塞，见 `.cursor/harness/spec/gate-chain.md` R9 脚注第 4 条 / workflow-gate-lib 的
